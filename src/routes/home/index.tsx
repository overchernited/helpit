...
import KeywordTag from "./components/tag";
            ...
            <div
                ...
                <Motion.div
                    ...
                    <Motion.div
                        ...
                        <Button btnStyle="button-palette" className="w-[10rem] text-3xl" onClick={() => { handleNext() }}>Si</Button>
                        <Button btnStyle="button-palette" className="w-[10rem] text-3xl" onClick={() => { }}>No</Button>
                    </Motion.div>
                    <Motion.a
                        initial={{ opacity: 0, y: -20 }}
                        animate={{ opacity: 1, y: 0 }}
                ...
                <Motion.div
                    ...
                    class="flex-col hidden md:flex bg-[var(--color-primary)] w-[60%] h-full rounded-2xl items-center justify-center">
                    <img alt="brand" height={500} width={500} src={brand}></img>
                    <p class="font-bold text-3xl text-white">De todos para todos.</p>
...
const SecondStep = (props: { onNext: () => void }) => {
    ...
    onMount(() => {
        ...
        setUser({ id: nanoid(), full_name: randomName.split(" ").join("") });
    ...
    return (
        ...
        <Motion.div
            ...
            <Motion.div
                ...
                class="hidden md:flex flex-col bg-[#ba5087] w-[60%] h-screen rounded-2xl items-center justify-center">
                <Motion.section
            ...
            <Motion.div
                ...
                <Motion.p
                    ...
                    class="text-3xl w-full md:w-[50%] text-center font-normal text-[var(--color-primary)]">
                    <span class="font-bold">helpit</span> es un lugar seguro y abierto a todos,
                    ...
                    <article class="my-5">
                        ...
                        <p class="text-4xl font-extrabold text-[var(--color-secondary)] break-all">{user().full_name}</p>
                    ...
                    <Button btnStyle="button-palette" className="w-[10rem] text-3xl" onClick={() => { handleNext() }}>Continuar</Button>
                </Motion.p>
            </Motion.div>
...
const ThirdStep = () => {
    ...
    const createAnonymousAccount = async () => {
        ...
        try {
            const { error } = await supa.auth.signUp({
                email: user().full_name + '@helpit.com',
                password: passwordWordgen.join('').toLowerCase(),
                options: {
                    data: {
                        full_name: user().full_name,
                        avatar_url: import.meta.env.VITE_START_SUPABASE_AVATAR_BUCKET + `/avatar${avatar()}.jpg`,
                    }
                },
            });
            if (error) {
    ...
    return (
        <div ref={divRef} class="w-screen h-[100vh] bg-[var(--color-primary)] flex flex-col items-center justify-center">
            ...
            <Button btnStyle="button-palette" className="w-[10rem] text-3xl my-6" onClick={() => { handleClick() }}>Continuar</Button>
        </div >
    )
}
const Home = () => {
