    ...
    return (
        <>
            <Public endpoint="/discover">
                <div
                    class="flex justify-center md:justify-between items-center w-screen h-screen gap-5"
                >
                    <div
                        class="h-full w-full md:w-[60vw] justify-center items-center rounded-2xl p-5 flex flex-col">
                    ...
                    <Motion.div
                        ...
                        class="hidden md:flex bg-[var(--color-primary)] h-full flex-col justify-center items-center">
                        <Motion.section
